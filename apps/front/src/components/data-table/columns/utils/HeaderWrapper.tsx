          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <span className="ml-2 cursor-help text-muted-foreground flex-shrink-0">
                <Sparkles className="h-4 w-4 text-primary" aria-label="Help" />
              </span>
            </TooltipTrigger>
            <TooltipContent
              side="top"
                ...
                <CardContent className="p-4 space-y-3">
                  ...
                  <div className="space-y-2.5">
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        Click it to instantly search and gather fresh data from
                        across the internet
                      </div>
                    </div>
                      ...
                      <div className="text-sm">
                        ...
                        <div className="mt-1 space-y-1">
                          ...
                          <div className="flex items-start gap-2">
                            ...
                            <span>
                              Enrichment failed, we were unable to find the data
                              (credits refunded)
                            </span>
                          </div>
                        </div>
