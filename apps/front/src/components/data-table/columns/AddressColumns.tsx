...
export const formattedAddressColumn: ColumnDef<SearchResult> = {
  ...
  header: () => <HeaderWrapper title="Address" />,
  enableSorting: false,
  cell: ({ row }) => {
...
export const countryColumn: ColumnDef<SearchResult> = {
  ...
  header: () => <HeaderWrapper title="Country" />,
  cell: ({ row }) => (
    <ColumnPinCopyCell
      id={row.original.id}
...
export const localityColumn: ColumnDef<SearchResult> = {
  ...
  header: () => <HeaderWrapper title="City" />,
  cell: ({ row }) => (
    <ColumnPinCopyCell
      id={row.original.id}
...
export const sublocalityColumn: ColumnDef<SearchResult> = {
  ...
  header: () => <HeaderWrapper title="Sublocality" />,
  cell: ({ row }) => (
    <ColumnPinCopyCell
      id={row.original.id}
...
export const postalCodeColumn: ColumnDef<SearchResult> = {
  ...
  header: () => <HeaderWrapper title="Postal Code" />,
  cell: ({ row }) => (
    <ColumnPinCopyCell
      id={row.original.id}
...
export const postalCodeSuffixColumn: ColumnDef<SearchResult> = {
  ...
  header: () => <HeaderWrapper title="Postal Code Suffix" />,
  cell: ({ row }) => (
    <ColumnPinCopyCell
      id={row.original.id}
...
export const plusCodeColumn: ColumnDef<SearchResult> = {
  ...
  header: () => <HeaderWrapper title="Plus Code" />,
  cell: ({ row }) => (
    <ColumnPinCopyCell
      id={row.original.id}
...
export const streetColumn: ColumnDef<SearchResult> = {
  ...
  header: () => <HeaderWrapper title="Street" />,
  cell: ({ row }) => (
    <ColumnPinCopyCell
      id={row.original.id}
...
export const neighborhoodColumn: ColumnDef<SearchResult> = {
  ...
  header: () => <HeaderWrapper title="Neighborhood" />,
  cell: ({ row }) => (
    <ColumnPinCopyCell
      id={row.original.id}
...
export const administrativeAreaLevel1Column: ColumnDef<SearchResult> = {
  ...
  header: () => <HeaderWrapper title="Administ. Area Level 1" />,
  cell: ({ row }) => (
    <ColumnPinCopyCell
      id={row.original.id}
...
export const administrativeAreaLevel2Column: ColumnDef<SearchResult> = {
  ...
  header: () => <HeaderWrapper title="Administ. Area Level 2" />,
  cell: ({ row }) => (
    <ColumnPinCopyCell
      id={row.original.id}
...
export const administrativeAreaLevel3Column: ColumnDef<SearchResult> = {
  ...
  header: () => <HeaderWrapper title="Administ. Area Level 3" />,
  cell: ({ row }) => (
    <ColumnPinCopyCell
      id={row.original.id}
...
export const addressComponentsColumn: ColumnDef<SearchResult> = {
  ...
  header: () => <HeaderWrapper title="Address Components" />,
  cell: ({ row }) => {
