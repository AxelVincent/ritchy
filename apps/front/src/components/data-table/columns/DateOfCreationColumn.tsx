...
const DateOfCreationCell = React.memo(function DateOfCreationCell({
  date,
}: {
  date: Date | string
}) {
...
export const dateOfCreationColumn: ColumnDef<SearchResult> = {
  id: 'dateOfCreation',
  accessorKey: 'companyDateOfCreation',
  meta: {
    filterVariant: 'date-range',
    isEnrichment: true,
  },
  accessorFn: (row) => {
    return row.companyDateOfCreation
  },
