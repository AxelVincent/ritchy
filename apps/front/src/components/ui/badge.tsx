  ...
  'inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-medium focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
        ...
        sky: 'border-transparent bg-sky-50 text-sky-700 dark:bg-sky-950 dark:text-sky-300',
        slate:
          'border-transparent bg-slate-50 text-slate-700 dark:bg-slate-900 dark:text-slate-300',
      },
    },
    defaultVariants: {
      variant: 'default',
