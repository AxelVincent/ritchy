...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-auto items-center bg-transparent p-0 text-muted-foreground border-b',
      className,
    )}
    {...props}
  />
