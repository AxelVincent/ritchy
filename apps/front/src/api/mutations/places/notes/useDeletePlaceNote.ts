...
import type {
  ...
  DeleteNoteParams,
} from '@api/routes_web/places/notes/delete-note/contract'
import type { Note } from '@api/routes_web/places/notes/list-notes/contract'
...
export const useDeletePlaceNote = () => {
  ...
  return useApiMutation<DeleteNoteApiResponse, DeleteNoteParams>(
