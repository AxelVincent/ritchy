 ...
 *
 * This route is now simplified - it just validates, creates enrichment records,
 * and enqueues jobs. The service layer handles idempotency (returning cached data
 * if already enriched).
 *
